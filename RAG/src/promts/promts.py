...
3. Сформулируй точный ответ и помести его между тегами <answer> и </answer>
...
Ответ для проверки:
{response}"""),
                ("human", "Требуется ли корректировка ответа? Если да, предложи улучшенную версию ответа и поместите его между тегами <answer> и </answer>.")
            ])
